...
class Internet:
    ...
    def traerInfoDeAlturas(self, puntoInicial:Punto, puntoFinal:Punto)->(list, str):
        ...
        url = 'https://maps.googleapis.com/maps/api/elevation/json?key=AIzaSyDeM3KkRrl1yet1xa_k-Nrzi5qp5Oe0YTo&path=' + path_str + '&samples=' + str(self.samples)
        print(url)
...
if __name__ == "__main__":
    ...
    punto2 = Punto("", 0, lonIn, latIn + 0.4, 20, "", 0)
    inter = Internet(5)
