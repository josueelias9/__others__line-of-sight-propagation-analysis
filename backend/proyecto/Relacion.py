...
class Relacion:
    ...
    def __str__(self):
        relacion = "{}\t{}\t{}".format(
            self.puntoInicial.nombre, self.puntoFinal.nombre, self.distancia
        )
        return relacion
    ...
    def distanciaEntrePuntos(self):
        ...
        h_0 = (
            self.puntoInicial.alturaAntena + self.puntoInicial.metrosSobreElNivelDelMar
        )
        ...
        self.distancia = math.sqrt(
            (y_f - y_0) ** 2 + (x_f - x_0) ** 2
        )  # OJO! ... la distancia esta en kilometros
