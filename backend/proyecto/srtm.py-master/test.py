...
class Tests(mod_unittest.TestCase):
    ...
    def test_over_60(self) -> None:
        geo_elevation_data = mod_srtm.get_data()
        self.assertTrue(geo_elevation_data.get_elevation(55.0, 55.0) > 0)  # type: ignore
        self.assertEqual(None, geo_elevation_data.get_elevation(65.0, 65.0))
        self.assertEqual(None, geo_elevation_data.get_elevation(75.0, 75.0))
    ...
    def test_files_equality(self) -> None:
        geo_elevation_data = mod_srtm.get_data()
        self.assertEqual(
            geo_elevation_data.get_file(47.0, 13.99),
            geo_elevation_data.get_file(47.0, 13.0),
        )
        self.assertEqual(
            geo_elevation_data.get_file(47.99, 13.99),
            geo_elevation_data.get_file(47.0, 13.0),
        )
    ...
    def test_without_approximation(self) -> None:
        ...
        self.assertEqual(
            geo_elevation_data.get_elevation(47.1, 13.1, approximate=False),
    ...
    def test_with_approximation(self) -> None:
        ...
        self.assertNotEquals(
            geo_elevation_data.get_elevation(47.1, 13.1, approximate=True),
            geo_elevation_data.get_elevation(47.1, 13.1),
        )
    ...
    def test_approximation(self) -> None:
        ...
        elevation_with_approximation = geo_elevation_data.get_elevation(
            47, 13, approximate=True
        )
        ...
        self.assertNotEqual(
            elevation_with_approximation, elevation_without_approximation
        )
    ...
    def test_InverseDistanceWeighted(self) -> None:
        ...
        controlpoints = [
            (44.1756325, -71.5965699, 801, 814),  # middle of tile (x,y)
            ...
            (44, -72, 341, 341),
        ]  # Exact cell coordinates, no interpolation
        ...
        for location in controlpoints:
            ...
            IDW13_elevation = tile._InverseDistanceWeighted(
                location[0], location[1], radius=2
            )
