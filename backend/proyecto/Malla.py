...
class Malla:
    ...
    def __init__(self, distanciaKilometrosX, distanciaKilometrosY, puntoInicial):
        ...
        self.puntoX = Punto(
            "",
            0,
            self.punto.longitud + Factor.deKilometrosAGrados(self.distanciaKilometrosX),
            self.punto.latitud,
            0,
            "",
            0,
        ...
        self.puntoY = Punto(
            ...
            0,
            self.punto.longitud,
            self.punto.latitud + Factor.deKilometrosAGrados(self.distanciaKilometrosY),
            0,
            "",
            0,
        )
        ...
        for j in range(0, self.numeroDeFilas):
            ...
            for i in range(0, self.numeroDeColumnas):
                punto = Punto(
                    "",
                    0,
                    self.punto.longitud + Factor.deKilometrosAGrados(self.pasosEnX) * i,
                    self.punto.latitud + Factor.deKilometrosAGrados(self.pasosEnY) * j,
                    0,
                    "",
                    0,
                )
