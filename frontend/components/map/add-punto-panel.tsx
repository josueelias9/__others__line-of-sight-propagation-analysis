...
export function AddPuntoPanel({ onAdded, onRequestPick, pickedCoords, onPickConsumed }: AddPuntoPanelProps) {
  ...
  return (
    <>
      ...
      <div className="absolute bottom-6 right-6 z-10 flex flex-col gap-2 items-end">
        <button
          onClick={() => { setForm(INITIAL_FORM); setError(null); setOpen(true); }}
            ...
            <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={() => { setOpen(false); onRequestPick(); }}
