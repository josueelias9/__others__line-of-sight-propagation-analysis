...
class ArchivoUno:
    ...
    def __init__(self):
        ...
        self.tecnico = TecnicoRed()
        self.impresora = InterfaceSalida()
        self.secretaria = InterfaceEntrada()
        ''''''
    ...
    def ponAlturaAPuntos(self):
        ...
        '''
        r = self.secretaria.ordenameInput2(Factor.entradaTexto1)
        self.tecnico.ponleAlturas(r)
        self.impresora.generarTxtDePuntos(r, Factor.entradaTexto1)
...
class ArchivoDos:
    ...
    def emergencia(self):
        ...
        para cada uno de los elementos de la lista noTiene
            ...
            la menor relacion'''
        siTiene = self.secretaria.ordenameInput2(Factor.entradaTexto1)
        noTiene = self.secretaria.ordenameInput2(Factor.entradaTexto2)
        ...
        self.impresora.generaKmlPuntos(siTiene, Factor.entradaTexto1)
        self.impresora.generaKmlPuntos(noTiene, Factor.entradaTexto2)
        #self.impresora.generarTxtDeRelaciones(lista, 'bitel')
        self.impresora.generaKmlRutas(lista, 'absolute', Factor.salidaKml3)
        self.impresora.generarTxtDePuntos(siTiene, Factor.entradaTexto1)
        self.impresora.generarTxtDePuntos(noTiene, Factor.entradaTexto2)
        print(contador)
        '''
        kmlSalida1 grafica puntos 1
        kmlSalida2 grafica puntos 3
        kmlSalida3 grafica relaciones y resultado final
        '''
